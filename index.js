...
There is a dummy account created with User ID ${'"' + user.user + '"'} to use the developed functionality of ATM built.`);
...
if (pinCodeAnswer.pin == user.pin) {
    console.log("Welcome to your Account. You may continue to perform your transaction.");
        ...
        },
        {
            ...
            when(operationAns) {
                ...
                if (operationAns.selectedType === "Balance Inquiry") {
                    console.log(`Dear ${user.user}, Your Balance is ${'"' + user.balance + '"'}.`);
                }
            },
        },
        {
    ...
    if ((user.balance = user.balance -= operationAns.amount))
        console.log(`Dear ${'"' + user.user + '"'}, Your remaining balance is ${user.balance}.`);
    else if (operationAns.amount >= user.balance) {
        console.log(`Dear ${'"' + user.user + '"'}, Your have insufficient balance to perform this transaction.`);
    }
}
else {
